class RegistrationsController < Devise::RegistrationsController
  ...
  def configure_devise_permitted_parameters
    ...
    registration_params = [:first_name, :middle_name, :last_name, :name, :email, :password, :password_confirmation, :time_zone, :firm_attributes => [:name, :id, :phone, :address, :address_2, :city, :state, :zip]]
