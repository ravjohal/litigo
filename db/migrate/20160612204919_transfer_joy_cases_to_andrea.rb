class TransferJoyCasesToAndrea < ActiveRecord::Migration
  def up
  	user_source = User.find_by_email("jmiller@tsmslaw.com")
  	user_target = User.find_by_email("aroberts@tsmslaw.com")

  	contact_source = Contact.find_by_email("jmiller@tsmslaw.com")
 ...
 #  	if user_source
  ...
  def down
  	...
  	user_target = User.find_by_email("jmiller@tsmslaw.com")

  	contact_source = Contact.find_by_email("aroberts@tsmslaw.com")
  	contact_target = Contact.find_by_email("jmiller@tsmslaw.com")
