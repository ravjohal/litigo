...
class CasesControllerTest < ActionController::TestCase
  ...
  test "should create case" do
    assert_difference('Case.count') do
      post :create, case: { description: @case.description, medical_bills: @case.medical_bills, name: @case.name, number: @case.number }
    end
  ...
  test "should update case" do
    patch :update, id: @case, case: { description: @case.description, medical_bills: @case.medical_bills, name: @case.name, number: @case.number }
    assert_redirected_to case_path(assigns(:case))
  end
