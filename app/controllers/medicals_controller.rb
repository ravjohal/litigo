  ...
  private
    ...
    def medical_params
      params.require(:medical).permit(:total_med_bills, :subrogated_amount, :injuries_within_three_days, :length_of_treatment, 
                                  ...
                                  :medical_bills_attributes => [:provider, :date_of_service, :company_id, :physician_id, :billed_amount, :paid_amount, :account_number, :adjustments, :id, :firm_id, :case_id, :user_id, :_destroy],
