class PlantiffsController < ApplicationController
  ...
  private
    ...
    def plantiff_params
      params.require(:plantiff).permit(:married, :employed, :job_description, :salary, :parent, :felony_convictions, :last_ten_years, :jury_likeability, :contact_attributes => [:id, :first_name, :middle_name, :last_name, :address, :city, :state, :phone_number, :fax_number, :email, :gender, :age, :contactable_id, :contactable_type])
    end
end
