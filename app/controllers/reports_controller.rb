class ReportsController < ApplicationController
  ...
  def leads_by_channel_report
  	...
  	@leads_by_channel_report = LeadsByChannelReport.new(start_date: @start_date, end_date: @end_date)
  end
  ...
  def leads_detail_report
  	...
  	@leads_detail_report = LeadsDetailReport.new(start_date: @start_date, end_date: @end_date, marketing_channel_arg: @marketing_channel_arg)
  end
