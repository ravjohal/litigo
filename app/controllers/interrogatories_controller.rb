class InterrogatoriesController < ApplicationController
  ...
  private
    ...
    def interrogatory_params
      params.require(:interrogatory).permit(:question, :response, :requester, :responder, :firm_id, :case_id, :created_by, :last_updated_by, :parent_id, :res_date, :req_date,
                                            :children_attributes => [:question, :response, :requester, :responder, :firm_id, :case_id, :created_by, :last_updated_by, :parent_id, :id, :res_date, :req_date, :_destroy])
    end
end
