class Event < ActiveRecord::Base
  ...
  def assign_nylas_while_refresh(ne, firm, user_id, calendar, namespace)
    assign_nylas_object!(ne, firm) { assign_attributes last_updated_by: user_id, owner_id: calendar.namespace.user_id, firm_id: firm.id, calendar_id: calendar.id, namespace_id: namespace.id } if id && !changed?
  end
