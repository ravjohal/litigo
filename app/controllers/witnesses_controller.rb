class WitnessesController < ApplicationController
  ...
  private
    ...
    def witness_params
      params.require(:witness).permit(:witness_type, :witness_subtype, :witness_doctype, :contact_attributes => [:id, :first_name, :middle_name, :last_name, :address, :city, :state, :phone_number, :fax_number, :email, :gender, :age, :contactable_id, :contactable_type])
    end
end
